...
platform1 = Platform(id=1, user_id=1, name='Playstation', medium='CD', internet_enabled=False, controller_ports=2, manufacturer='Sony', release_date=datetime.date(1994, 12, 3))
...
platform2 = Platform(id=2, user_id=1, name='Nintendo 64', manufacturer='Nintendo', release_date=datetime.date(1996, 9, 26), medium='cartridge', internet_enabled=False, controller_ports=4)
...
game7 = Game(user_id=1, title='The Legend of Zelda: Ocarina of Time', developer='Nintendo EAD',
...
game8 = Game(user_id=1, title='Perfect Dark\"', developer='Rare', publisher='Nintendo', 
...
platform3 = Platform(id=3, user_id=1, name='Xbox 360', manufacturer='Microsoft', release_date=datetime.date(2005, 11, 22), 
...
game12 = Game(user_id=1, title='Grand Theft Auto V', developer='Rockstar North', publisher='Rockstar Games', 
...
game12 = Game(user_id=1, title='Halo 3 ODST', developer='Bungie Studios', publisher='Microsoft Games', 
    genre='Shooter', multiplayer=True, online_multiplayer=True, multiplatform=False,
